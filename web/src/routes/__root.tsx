  ...
  head: () => ({
    meta: [
      ...
      { title: "AI Video Creator" },
      {
        name: "description",
        content:
          "Esteira de conteudo em video para Dr. Guilherme: tendencias, ideias, roteiros com validacao medica, producao e calendario.",
      },
      { name: "author", content: "AI Video Creator" },
